Feature: Create VASP contract
  ...
  Scenario Outline: Creating VASP contract
    ...
    Examples:
      ...
      | a VASP Index deployer     | the zero address | not used yet   | failure                      | OwnerRole: owner is the zero address  |
      ...
      | not a VASP Index deployer | the zero address | not used yet   | failure                      | OwnerRole: owner is the zero address  |
